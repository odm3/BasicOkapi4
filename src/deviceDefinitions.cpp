...
/****************************/
 ...
 Motor rightIntake(15,false, AbstractMotor::gearset::red, AbstractMotor::encoderUnits::degrees);
 Motor leftIntake(17, true, AbstractMotor::gearset::red, AbstractMotor::encoderUnits::degrees);
